...
/** 
* @credits MaysLastPlay, MarioMaster (MasterX-39)
* @version: 0.2.1
**/
...
class MobileUtil {
  ...
  public static function getDirectory():String {
   currentDirectory = #if android if(VERSION.SDK_INT >= 30)
   ...
   */
    ...
    if(VERSION.SDK_INT >= 33){
      ...
      Permissions.requestPermissions(['READ_DATA_STORAGE', 'WRITE_DATA_STORAGE']);
	  }
